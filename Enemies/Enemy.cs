...
public partial class Enemy : CharacterBody3D
{
    ...
    [Export] public float DetectionRadius = 8f; // determines the size of the DetectionArea
    ...
    /// </summary>
    /// <param name="delta"></param> <summary>
    public virtual void MoveToTargetPosition(float delta)
    {
        Vector3 velocity = Velocity;
        ...
        Vector3 sightDirection = _lastSightDirection.Lerp(targetPoint, 0.2f);
    ...
    #region SIGNALS
    // requires an Area3D node called DetectionRadius
    private void _on_detection_radius_body_entered(Node3D body)
    {
    ...
    private void _on_detection_radius_body_exited(Node3D body)
    {
